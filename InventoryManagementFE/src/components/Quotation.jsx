  ...
  const handlePrintQuotation = (quotation) => {
    ...
    if (printWindow) {
      ...
      const printContent = `
        ...
        <body>
          <div class="header">
            <img src="/avva-logo.jpeg" class="company-logo" alt="Beniyel Traders Logo">
          ...
          <div style={{ ...styles.modal, maxWidth: '900px' }} ref={viewModalRef}>
            ...
            <div style={styles.modalContent}>
              ...
              <div style={styles.viewCompanyHeader}>
                <img src="/avva-logo.jpeg" alt="Beniyel Traders Logo" style={{ maxWidth: '120px', marginBottom: '10px' }} />
